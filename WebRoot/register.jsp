					...
					<td style="padding:30px">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<input type="text" class="textinput"
									name="email" onblur="checkEmail(this, '${pageContext.request.contextPath }')"/></td>
								<td><span id="emailMessage"><font color="#999999">请输入有效的邮箱地址</font></span></td>
							</tr>
							<tr>
								<td style="text-align:right">会员名：</td>
								<td>
									<input type="text" class="textinput" name="username" onblur="checkUsername(this, '${pageContext.request.contextPath }')"/>
								</td>
								<td><span id="usernameMessage"><font color="#999999">用户名设置至少6位</font></span></td>
							</tr>
							<tr>
								<td style="text-align:right">密码：</td>
								<td><input type="password" class="textinput"
									name="password" onblur="checkPassword(this)"/></td>
								<td><span id="pwdMessage"><font color="#999999">密码设置至少6位</font></span></td>
							</tr>
							<tr>
								<td style="text-align:right">重复密码：</td>
								<td><input type="password" class="textinput"
									name="repassword" onblur="checkRePassword(this)"/></td>
								<td><span id="rePwdMessage"></span></td>
							</tr>
							<tr>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width:50%">
									<input type="text" class="textinput" name="validateCode" onblur="checkvalidateCode(this, '${pageContext.request.contextPath }')"/>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span id="validateCodeMsg"><font color="red" size="2">${validateCodeErrorMsg }</font></span>
								</td>
								<td></td>
							</tr>
							<tr>
						...
						<table width="70%" border="0" cellspacing="0">
							<tr>
								<td style="padding-top:20px; text-align:center">${registerErrorMsg }</td>
							</tr>
							<tr>
