...
<script type="text/javascript">
	...
	function deleteOrder(orderId, id) {
		...
		// 建立与服务器的异步连接
		var url = "${pageContext.request.contextPath }/order?action=deleteOrder&orderId=" + orderId + "&time=" + new Date().getTime();
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/order?action=orderList">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<c:forEach var="order" items="${orders }" varStatus="vs">
										<tr id="${vs.count }">
											...
											<td class="tableopentd03"><a href="${pageContext.request.contextPath }/order?action=orderInformation&orderId=${order.id }">查看</a>&nbsp;&nbsp;
